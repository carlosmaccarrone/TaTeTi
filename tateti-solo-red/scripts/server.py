...
def funcionParaSalirSERVENT(ventana_):
...
def mostrarTableroSERVENT(ventana_, tablero):
	...
	opcionMenu = [ 
		Opcion('Salir', (645, 540), funcionParaSalirSERVENT, fuenteParaMenu, ventana_)
					   ]

	opcionesVolverAJugar = [
		Opcion('Si', (200, 560), funcionParaVolverAJugarSERVENT, fuenteParaVolver, ventana_),
		Opcion('No', (250, 560), funcionParaSalirSERVENT, fuenteParaVolver, ventana_)
									]
