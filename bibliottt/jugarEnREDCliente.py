...
def funcionParaSalirAlMenuCLIENTE(ventana_):
	global casilleros, conexion_, REACTORBANDERA
	try:
		casilleros[13] = False
		for i in range(1,20):
			casilleros[i] = ' '
		conexion_.transport.write(str( casilleros ))
		conexion_.transport.loseConnection()
	except: pass
	REACTORBANDERA = False
...
def funcionParaVolverAJugarCLIENTE(ventana_):
	...
	if casilleros[13] is False:
		funcionParaSalirAlMenuCLIENTE(ventana_)
